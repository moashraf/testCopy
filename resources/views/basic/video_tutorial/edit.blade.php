...
@section('title', 'Video tutorials | Tripo - Medical Management app')
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.video_tutorial.index') }}">
                {{ __('basic.video tutorials') }} | </a>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-body px-4 px-md-5">
            ...
            <form id="myform" method="POST" action="{{ route('sett.video_tutorial.update', $slider->id) }}"
                    ...
                    <div class="col-12 col-md-10 col-lg-7">
                        <div class="row mb-2 ">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select id="type" readonly disabled
                                    class="js-example-basic-single select2-hidden-accessible @error('type') is-invalid @enderror"
                                    name="type">
                                    <option @if ($slider->type == 1) selected @endif value="1">Welcomeing Page</option>
                                    <option @if ($slider->type == 2) selected @endif value="2">Dashboard Page</option>
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label">{{ __('basic.url') }}
                                    <small>({{ __('basic.required') }})</small></label>
                                <input id="title_name" name="url" type="text"
                                    class="form-control @error('url') is-invalid @enderror" placeholder="Youtube URL.."
                                    value="{{ $slider->url }}">
                                @error('url')
                                <span class="error-msg-form">
                                    {{ $message }}
