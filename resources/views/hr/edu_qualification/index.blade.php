...
@section('title', 'Educational Qualifications | Lam - School Management App')

@section('title-topbar', __('basic.educational qualifications'))
...
<div class="container-fluid px-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="text-gray-300">{{ __('basic.educational qualifications') }}</a>
        </span>

        <div class="d-flex justify-content-center">
            <a href="{{ route('sett.user_edu_qualification.create') }}"
    ...
    <div class="card shadow mb-3 pb-2">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-hotel me-2"></i>
                {{ __('basic.educational qualifications') }}</h6>
            <div class="dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                    ...
                    <a class="dropdown-item" href="{{ route('sett.user_edu_qualification.index') }}"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('sett.user_edu_qualification.edit', $item->id) }}"
                                    class="btn btn-sm status-col-link active-color-btn b-r-xs mb-1" title="edit"><i
                                        class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-sm status-col-link active-color-btn b-r-xs mb-1 cancel-color-btn"
                                    data-bs-toggle="modal" data-bs-target="#delete_modal{{ $item->id }}"><i
                                ...
                                <div class="modal fade" id="delete_modal{{ $item->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                        <div class="modal-content b-r-s-cont border-0">
                                            ...
                                            <form action="{{ route('sett.user_edu_qualification.destroy', 'test') }}"
                                                method="post">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
