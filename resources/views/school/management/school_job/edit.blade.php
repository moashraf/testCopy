...
@section('title', 'School jobs | Lam - School Management App')

@section('title-topbar', __('basic.school jobs'))
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.school_job.index') }}">{{
                __('basic.school jobs') }} |
            </a>
            <a class="text-gray-300">{{ __('basic.school jobs') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-body px-4 px-md-5">
            ...
            <form id="myform" method="POST" action="{{ route('sett.school_job.update', $askfor->id) }}">
                @csrf
                @method('PUT')
