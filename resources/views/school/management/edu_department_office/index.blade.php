...
<div class="container-fluid px-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex justify-content-center">
            <a href="{{ route('sett.edu_department_office.create') }}"
                ...
                <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-xxs">{{ __('basic.category') }}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('sett.edu_department_office.edit', $item->id) }}"
                                ...
                                <div class="modal fade" id="delete_modal{{ $item->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                        <div class="modal-content b-r-s-cont border-0">
                                            ...
                                            <form action="{{ route('sett.edu_department_office.destroy', 'test') }}"
                                                method="post">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
