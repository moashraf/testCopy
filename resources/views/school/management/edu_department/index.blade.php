...
@section('title', 'Education department | Lam - School Management App')

@section('title-topbar', __('basic.education department'))
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="text-gray-300">{{ __('basic.education department') }}</a>
        </span>

        <div class="d-flex justify-content-center">
            <a href="{{ route('sett.edu_department.create') }}"
    ...
    <div class="card shadow mb-3 pb-2">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-school me-2"></i>
                {{ __('basic.education department') }}</h6>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('sett.edu_department.edit', $item->id) }}"
                                ...
                                <div class="modal fade" id="delete_modal{{ $item->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                        <div class="modal-content b-r-s-cont border-0">
                                            ...
                                            <form action="{{ route('sett.edu_department.destroy', 'test') }}"
                                                method="post">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
