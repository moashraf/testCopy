...
<script>
    ...
    setTimeout(function(){  
        $('#otp_resend').html(
            '<h6 class="text-gray-400">اذا لم يصلك رمز التحقق <span class="fw-bold text-gray-700 clickable-item-pointer text-decoration-underline" id="otp_btn" data-type="resend">اضغط هنا لارسال الكود مرة اخري </span></h6>'
        ) 
    ...
    e.preventDefault();
        ...
        var url = "{{ route('school_route.check_otp_forget_password') }}";
        ...
        $.ajax({
            ...
            , success: function(data) {
                ...
                if (data.status === "resend") {
                    ...
                    $('#otp_resend').html(
                        '<h6 class="text-gray-400">اذا لم يصلك رمز التحقق يمكنك ارسال كود اخر خلال <span class="fw-bold text-gray-700" id="otp_resend_seconds">' + diff_seconds + '</span> ثانية</h6>'
                    )
                    ...
                    setTimeout(function(){  
                    $('#otp_resend').html(
                        '<h6 class="text-gray-400">اذا لم يصلك رمز التحقق <span class="fw-bold text-gray-700 clickable-item-pointer text-decoration-underline" id="otp_btn" data-resend="true">اضغط هنا لارسال الكود مرة اخري </span></h6>'
                    ) }, delay);
                    ...
                    var url = '{{ route("school_route.new_page_forget_password") }}';
