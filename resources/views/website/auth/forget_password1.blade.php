...
<div class="login_page_cont"
    ...
    <div class="login_page_side p-5">
                ...
                <div class="text-start my-5">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input id="email" name="email" type="email" class="form-control"
                            placeholder="Write here your Phone Number or Email">
                        @error('email')
        ...
        <div class="text-center my-5" id="correct_opt_cont" style="display: none">
            ...
            <h5 class="fw-bold">
                We have sent the Rest Password Link to your account, Please look at Spam Folder
            </h5>
...
<script>
    //otp confirm
        ...
        var url = "{{ route('school_route.check_forget_password') }}";
