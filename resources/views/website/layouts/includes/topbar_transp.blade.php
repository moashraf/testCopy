<nav class="navbar navbar_main mb-5 pt-0 px-0 px-lg-5">
    <a href="{{ route('website_homepage') }}">
        <img width="170px" src="{{ URL::asset('img/website/logo/destino_color.png') }}" title="cover">
    </a>
    <div class="d-none d-xl-block">
        <ul class="mx-auto mb-2 mb-lg-0 text-white ps-0">
            <li>
                <a class="nav-link text-shadow-200 active" aria-current="page"
                    href="{{ route('school_route.show_tag', 'visit_egypt') }}">Visit Egypt</a>
            </li>
            <li>
                <a class="nav-link text-shadow-200" aria-current="page"
                    href="{{  route('school_route.all_airline')  }}">Flights</a>
            </li>
            <li>
                <a class="nav-link text-shadow-200" aria-current="page"
            ...
            <li>
                <a class="nav-link text-shadow-200" aria-current="page"
                    href="{{ route('school_route.all_visa') }}">Visa</a>
            </li>

            <li>
                <a class="nav-link" aria-current="page" href="{{ route('school_route.all_transp') }}">
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle text-shadow-200 nav-link" href="#" role="button" id="dropdownMenuLink"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Domestic
                        </a>
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="{{ route('school_route.show_destination', 'hurghada') }}">
                                Hurghada</a>
                            <a class="dropdown-item"
                                href="{{ route('school_route.show_destination', 'sharm-el-sheikh') }}">
                                Sharm El-sheikh</a>
                            <a class="dropdown-item" href="{{ route('school_route.show_destination', 'dahab') }}">
                                Dahab</a>
                            <a class="dropdown-item" href="{{ route('school_route.show_destination', 'marsa-alam') }}">
                                Mara Alam</a>
                        </div>
                    </div>
                </a>
            ...
            <li>
                <a class="nav-link" aria-current="page" href="{{ route('school_route.articles') }}">Inspiration</a>
            </li>
        </ul>
    </div>
    ...
    <div class="d-none d-xl-block">
        <div class="d-flex align-items-center">
            ...
            <span class="nav-link text-white me-3 clickable-item-pointer show_smal_cart_id" data-bs-toggle="offcanvas"
            ...
            <div class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle d-flex" href="#" id="userDropdown" role="button"
                    ...
                    <div class="ms-2 my-auto">
                        ...
                        <h6 class="text-gray-200 fw-bold mb-0 text-capitalize">{{
                ...
                <div class="dropdown-list-profile dropdown-list-profile-website border-0 dropdown-menu dropdown-menu-right shadow animated--grow-in py-0"
                    ...
                    <div class="dropdown-header bg-primary p-3 px-3" style="background-color: #0670D4 !important; ">
                        <div class="d-flex wd-100p">
                            <div class="main-img-user">
                                <img class="img-profile rounded-circle avatar-small2" alt=""
                                    src="{{ URL::asset('img/useravatar/' . Auth::guard('school')->user()->avatar) }}"
                                    class="">
                            </div>
    ...
    <div class="d-flex d-xl-none align-items-center">
        <span class="nav-link text-white me-3 clickable-item-pointer show_smal_cart_id" data-bs-toggle="offcanvas"
            data-bs-target="#offcanvas_small_cart" aria-controls="offcanvas_small_cart" aria-current="page">
            <i class="fa-solid fa-basket-shopping fs-5 pt-2"></i>
        </span>
