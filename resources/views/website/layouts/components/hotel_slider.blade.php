<div class="swiper-slide">
    <div class="product">
        ...
        <a href="{{ route('school_route.unit_show', [$item->slug, 'direct']) }}"> <img class="mb-2 img_slider"
                src="{{ URL::asset('img/unit/' . $item->main_image) }}" title="cover">
        </a>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <a href="{{ route('school_route.unit_show', [$item->slug, 'direct']) }}"
                    class="text-gray-900 fw-light text-s">{{
                    $item->name }}</a>
                <div>
                    <a href="#" class="text-gray-400 fw-light text-s">
