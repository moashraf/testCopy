...
<div class="justify-content-between align-items-center mt-5 mb-3">
    ...
    <div
        ...
        <div class="d-flex align-items-center">
            <img src="{{ URL::asset('img/products/' . $unit_packages->package_offer->package->main_image) }}"
            ...
            <div class="m-2">
                ...
                <a class="fs-7 link-cust-text text-gray-900 fw-bold mb-1"
                    ...
                    {{ $unit_packages->package_offer->name }}
                </a>
                <div class="fs-8 gray"><i class="fa-solid fa-location-dot me-1 blue"></i>{{
                    $unit_packages->package_offer->package->destination->name }}</div>
        ...
        <div class="m-1">
            ...
            <p class="fs-8 gray m-0">
                <i class="fa-solid fa-user me-2 blue"></i> {{ $unit_packages->qty }}
                people
            </p>
        </div>
