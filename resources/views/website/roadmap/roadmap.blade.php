...
<div class="cont_wrapper pb-2">
    ...
    <div class="main_cont py-4 px-4">
        ...
        {{-------- 1-2- Welcome Page --------}}
        <div class="cont_tap" @if(in_array($roadmap, [1,2])) style="display: block" @else style="display: none" @endif
            id="clinics">

            <form id="myform">

                @if(in_array($roadmap, [1,2]))
                <!-- Modal for search filtering -->
                <div class="modal fade" id="choose_school_modal" tabindex="-1" role="dialog" data-bs-backdrop="static"
                        ...
                        <div class="modal-content b-r-s-cont border-0">
                            <div class="modal-header" style="border: 0px">
                                <h5 class="modal-title text-center" id="exampleModalLabel">
                                    شكراً لك لاعتمادك <span class="main-color">نظام لام </span> في إدارة مدرستك
                                </h5>
                            </div>
                            ...
                            <div class="modal-body px-5 py-3">
                                ...
                                <div class="text-center mb-3">
                                    <p class="fs-6 text-gray-400 mb-1 text-xs">
                                        لبدء في استخدام النظام
                                    </p>
                                    <h4 class="fw-bold main-color">هل مدرستك مشتركة أم غير مشتركة ؟</h4>
                                </div>

                                <div class="d-flex justify-content-center mb-4 flex-wrap">
                                    <div class="p-3 ms-2 ms-md-3 mb-3 mb-md-0 yes_shared_school_btn shared_school_btn text-center"
                                        data-type="2">
                                        <div class="d-flex justify-content-between mb-3 align-items-center">
                                            <img class="platform_icon" alt="school"
                                                src="{{ URL::asset('img/icons/roadmap/school_yellow.svg') }}">
                                            <img class="platform_icon" alt="school"
                                                src="{{ URL::asset('img/icons/roadmap/exchange.svg') }}">
                                            <img class="platform_icon" alt="school"
                                                src="{{ URL::asset('img/icons/roadmap/school_yellow.svg') }}">
                                        </div>
                                        <h6 class="mb-0">نعم, مدرسة مشتركة</h6>
                                    </div>

                                    <div class="p-3 ms-2 ms-md-3 mb-3 mb-md-0 no_shared_school_btn shared_school_btn text-center"
                                        data-type="1">
                                        <div class="d-flex justify-content-center mb-3 align-items-center">
                                            <img class="platform_icon" alt="school"
                                                src="{{ URL::asset('img/icons/roadmap/school_blue.svg') }}">
                                        </div>
                                        <h6 class="mb-0">لا, مدرسة مشتركة</h6>
                                    </div>
        ...
        {{-------- 3- General Info --------}}
        <div class="cont_tap" @if($roadmap==3) style="display: block" @else style="display: none" @endif id="clinics">
                ...
                <div>
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <div class="d-flex">
                                <div class="check_custom_index me-5">
                                    ...
                                    <input @if($first_school) @if($first_school->gendar == 1)
                                    checked
                                    @endif
                                    @else checked
                                ...
                                <div class="check_custom_index me-3">
                                    <input @if($first_school) @if($first_school->gendar == 2)
                                    checked
                                    @endif
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            ...
                            <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                ...
                                <option @if($first_school) @if($first_school->level == 1)
                                    selected @endif @endif value="1">المرحلة الابتدائية</option>
                                <option @if($first_school) @if($first_school->level == 2)
                                    selected @endif @endif value="2">المرحلة الاعدادية</option>
                                <option @if($first_school) @if($first_school->level == 3)
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <input name="school_name" type="text" class="form-control" maxlength="100"
                                ...
                                value="@if($first_school){{ $first_school->name }}@endif" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <input name="ministerial_number" type="text" minlength="4" maxlength="40"
                                ...
                                value="@if($first_school){{ $first_school->ministerial_number }}@endif" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <div class="d-flex">
                                <div class="check_custom_index me-5">
                                    <input @if($first_school) @if($first_school->school_type == 1)
                                    checked
                                    @endif
                                    @else checked
                                ...
                                <div class="check_custom_index me-3">
                                    <input @if($first_school) @if($first_school->school_type == 2)
                                    checked
                                    @endif
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            ...
                            <select class="js-example-basic-single select2-hidden-accessible" name="school_department"
                                ...
                                <option @if($first_school) @if($first_school->edu_department_id == $item->id)
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            ...
                            <select class="js-example-basic-single select2-hidden-accessible"
                                ...
                                @if($first_school)
                                <option selected value="{{ $first_school->edu_department_office_id }}">{{
                                    $first_school->department_office->name }}</option>
                                @else
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            ...
                            <div class="input-group">
                                ...
                                <input name="established_date" type="text" style="border-left: 0px;"
                                    ...
                                    value="@if($first_school){{ $first_school->established_date }}@endif" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <div class="d-flex">
                                <div class="check_custom_index me-5">
                                    <input @if($first_school) @if($first_school->school_period == 1)
                                    checked
                                    @endif
                                    @else
                                    checked
                                ...
                                <div class="check_custom_index me-5">
                                    <input @if($first_school) @if($first_school->school_period == 2)
                                    checked
                                    @endif
                                ...
                                <div class="check_custom_index me-3">
                                    <input @if($first_school) @if($first_school->school_period == 3)
                                    checked
                                    @endif
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <input name="address" type="text" class="form-control" minlength="5" maxlength="255"
                                ...
                                value="@if($first_school){{ $first_school->address }}@endif" required>
        ...
        {{-------- 4- Facilities --------}}
        <div class="cont_tap" @if($roadmap==4) style="display: block" @else style="display: none" @endif
            id="facilities">
            <h5 class="text-gray-800 fw-bold mb-5"><svg class="me-2" width="23" height="23" viewBox="0 0 23 23"
                ...
                <div>
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <div class="d-flex">
                                <div class="check_custom_index me-5">
                                    <input @if($first_school) @if($first_school->building_type == 1)
                                    checked
                                    @else
                                    checked
                                    @endif
                                    ...
                                    checked
                                    @endif
                                    type="radio" id="building_type_gov" name="building_type" value="1">
                                ...
                                <div class="check_custom_index me-3">
                                    <input @if($first_school) @if($first_school->building_type == 2)
                                    checked
                                    @endif
                                    @endif
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-7 col-xl-7">
                            <div class="d-flex">
                                <div class="check_custom_index me-5">
                                    <input @if($first_school) @if($first_school->building_status == 1)
                                    checked
                                    @else
                                    checked
                                    @endif
                                ...
                                <div class="check_custom_index me-4">
                                    <input @if($first_school) @if($first_school->building_status == 2)
                                    checked
                                    @endif
                                ...
                                <div class="check_custom_index me-3">
                                    <input @if($first_school) @if($first_school->building_status == 3)
                                    checked
                                    @endif
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="classes_number" type="number" min="0" max="2000"
                                        ...
                                        value="@if($first_school){{ $first_school->classes_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="bathroom_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->bathroom_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="floors_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->floors_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="teachers_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->teachers_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="management_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->management_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="computers_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->computers_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="lab_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->lab_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="stock_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->stock_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="learning_resources_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->learning_resources_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="activities_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->activities_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="meetings_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->meetings_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="sport_room_number" type="number" max="2000" class="form-control"
                                        placeholder="العدد"
                                        value="@if($first_school){{ $first_school->sport_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="theaters_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->theaters_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="grounds_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->grounds_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="outdoor_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->outdoor_room_number }}@else 0 @endif"
                                        required>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input name="indoor_room_number" type="number" min="0" max="2000"
                                        class="form-control facilities_number" placeholder="العدد"
                                        value="@if($first_school){{ $first_school->indoor_room_number }}@else 0 @endif"
                                        required>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-7">
                            <div class="row mb-4">
                                ...
                                <div class="col-12 col-md-8 col-xl-4">
                                    <input id="total_facilities_rooms" value="@if($first_school){{ $first_school->total_rooms
                                    }}@endif" type="text" disabled class="form-control text-center fw-bold"
    ...
    {{-------- 5- Students --------}}
    <div class="cont_tap" @if($roadmap==5) style="display: block" @else style="display: none" @endif id="students">
    ...
    {{-------- 6- Entsab --------}}
    <div class="cont_tap" @if($roadmap==6) style="display: block" @else style="display: none" @endif id="entsab">
        ...
        <form id="myform_entsab" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <div class="d-flex">
                            <div class="check_custom_index me-5">
                                <input type="hidden" name="school" value="fr1ksa">
                                <input type="radio" id="have_entsab_yes" name="have_entsab" value="1" required>
                            ...
                            <div class="check_custom_index me-5">
                                <input type="radio" id="have_entsab_no" name="have_entsab" value="0" required>
                ...
                <div id="have_entsab_cont" style="display: none">
                    ...
                    @foreach ($first_school_grades as $item)
                    <div class=" row mb-4">
                        <div class="col-12 col-md-4 col-xl-4 align-self-center">
    ...
    {{-------- 7- Teachers --------}}
    <div class="cont_tap" @if($roadmap==7) style="display: block" @else style="display: none" @endif id="teachers">
        <h5 class="text-gray-800 fw-bold mb-3">
            <svg class="me-2" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    {{-------- 8- Administrator --------}}
    <div class="cont_tap" @if($roadmap==8) style="display: block" @else style="display: none" @endif id="administrator">
        <h5 class="text-gray-800 fw-bold mb-3">
            <svg class="me-2" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {{-------- 9- other Info --------}}
    <div class="cont_tap" @if($roadmap==9) style="display: block" @else style="display: none" @endif id="other_info">
        ...
        <form id="myform_other_info" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        ...
                        <input name="school_telephone" type="text" class="form-control" maxlength="100"
                            placeholder="01XXXXXXXX" value="@if($first_school){{ $first_school->telephone }}@endif">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-5 mb-2 mb-md-0">
                        <input name="school_phone_number" type="text" minlength="4" maxlength="40" class="form-control"
                            placeholder="5XXXXXXXX" value="@if($first_school){{ $first_school->phone_number }}@endif"
                            required>
                    ...
                    <div class="col-12 col-md-3 position-relative">
                        ...
                        <input name="school_whatsapp" type="text" minlength="4" maxlength="40" class="form-control ps-5"
                            ...
                            value="@if($first_school){{ $first_school->whatsapp }}@endif">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_twitter" type="text" minlength="4" maxlength="40" class="form-control"
                            placeholder="@username" value="@if($first_school){{ $first_school->twitter }}@endif"
                            required>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_website" type="text" minlength="5" maxlength="40" class="form-control"
                            placeholder="www.website.com" value="@if($first_school){{ $first_school->website }}@endif">
                ...
                <hr>
                <h6 class="text-gray-400">مواقع تواصل اجتماعية أخرى يمكنك إضافتها</h6>
                <div class="row mb-4">
                    <div class="col-12 col-md-4 col-xl-4 align-self-center">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_facebook" type="text" minlength="2" maxlength="40" class="form-control"
                            placeholder="User Name" value="@if($first_school){{ $first_school->facebook }}@endif">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_snapchat" type="text" minlength="2" maxlength="40" class="form-control"
                            placeholder="@username" value="@if($first_school){{ $first_school->snapchat }}@endif">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_tiktok" type="text" minlength="2" maxlength="40" class="form-control"
                            placeholder="@username" value="@if($first_school){{ $first_school->tiktok }}@endif">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-7 col-xl-7">
                        <input name="school_telegram" type="text" minlength="2" maxlength="40" class="form-control"
                            placeholder="@username" value="@if($first_school){{ $first_school->telegram }}@endif">
                        <div id="school_tiktok-js_error_valid"></div>
    ...
    {{-------- 10- finish --------}}
    <div class="cont_tap" @if($roadmap==10) style="display: block" @else style="display: none" @endif id="other_info">
        ...
        <div class="text-center" id="cong_page" style="display: none">
            ...
            <h3 class="mb-4 fw-bold">اهلا بك في منصة لام<br>
                ...
                @if(Auth::guard('school')->user()->first_school)
        ...
        <div class="text-center py-5" id="choose_school_page">
            ...
            @if(Auth::guard('school')->user()->shared_school == 1)
            <a href="#" id="move_to_next_school" type="button" data-school_type="1"
                class="main_btn border_radius_20 px-5 fw-bold finished_roadmap_btn">انتقل الي الصفحة الرئيسية</a>
            @else
            <a href="#" id="move_to_dashboard" type="button" data-school_type="1"
                class="main_btn border_radius_20 px-5 fw-bold finished_roadmap_btn">انتقل الى
                رحلة المدرسة التالية</a>
            @endif
        </div>
