...
@section('title', 'Sliders | Lam - School Management App')
...
<div class="container-fluid px-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            ...
            <a class="text-gray-300">Sliders Controll</a>
        </span>

        <div class="d-flex justify-content-center">
            <a href="{{ route('sett.slider.create') }}"
    ...
    <div class="card shadow mb-3 pb-2">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-2"></i>Slider Controll</h6>
                        ...
                        <tr>
                            ...
                            <td>
                                <img class="rounded-circle avatar-small me-2"
                                    src="{{ URL::asset('img/sliders/' . $iteam->img) }}">
                            </td>

                            <td>
                                @if ($iteam->type == 1)
                                @php
                                $type = "First slide in hp";
                                @endphp
                                @elseif ($iteam->type == 2)
                                @php
                                $type = "Second slide in hp left";
                                @endphp
                                @elseif ($iteam->type == 3)
                                @php
                            ...
                            <td class="text-center">
                                <a href="{{ route('sett.slider.edit', $iteam->id) }}"
