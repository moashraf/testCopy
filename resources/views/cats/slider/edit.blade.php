...
@section('title', 'Edit Slider | Tripo - Medical Management app')

@section('title-topbar', __('basic.edit slider'))
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.slider.index') }}">
                {{ __('basic.sliders') }} | </a>
            <a class="text-gray-300">{{ __('basic.edit slider') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-1"></i> {{ __('basic.edit slider')
                }}</h6>
        </div>
        ...
        <div class="card-body px-4 px-md-5">
            ...
            <form id="myform" method="POST" action="{{ route('sett.slider.update', $slider->id) }}"
                        ...
                        <div class="row mb-2 ">
                            ...
                            <div class="col-12 align-self-start mb-2">
                                <div class="avatar-update-container">
                                    <div class="picture">
                                        <img src="{{ URL::asset('img/sliders/' . $slider->img) }}" class="picture-src"
                                            id="mib_PicturePreview" title="" />
                                        <input type="file" name='img' accept="image/*" id="mib_img_input">
                                    </div>
                                    <h6 class="text-gray-300">{{ __('basic.choose images') }}</h6>
                                    @error('img')
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <textarea class="description" name="description">{{ $slider->description }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select id="type"
                                    ...
                                    name="type">
                                    <option @if ($slider->type == 1)
                                        selected
                                        @endif value="1">First slide in hp</option>
                                </select>
