...
@section('title', 'New Slider | Lam - School Management App')

@section('title-topbar', 'New Slider')
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            ...
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.slider.index') }}">
                {{ __('basic.sliders') }} | </a>
            <a class="text-gray-300">{{ __('basic.new slider') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-1"></i> New Slider</h6>
        </div>

        <!-- Card Body -->
        <div class="card-body px-4 px-md-5">

            <form id="myform" method="POST" action="{{ route('sett.slider.store') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row mb-2 ">
                            <div class=" col-12 align-self-start mb-2">
                                <div class="avatar-update-container">
                                    ...
                                    <h6 class="text-gray-300">{{ __('basic.choose image') }} </h6>
                                    @error('img')
                            ...
                            <div class="col-12 mb-2">
                                <label class="form-label">{{ __('basic.description') }} <small>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select id="type"
                                    ...
                                    name="type">
                                    <option value="1">{{ __('basic.first slide in hp') }}</option>
                                </select>
