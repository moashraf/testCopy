...
@section('title', 'Edit Tag | Tripo - Medical Management app')

@section('title-topbar', __('basic.edit tag'))
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            ...
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.tag.index') }}">{{ __('basic.tags') }}
                | </a>
            <a class="text-gray-300">{{ __('basic.edit tag') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-1"></i> {{ __('basic.edit tag') }}
            </h6>
        </div>
        ...
        <div class="card-body px-4 px-md-5">
            ...
            <form id="myform" method="POST" action="{{ route('sett.tag.update', $tags->id) }}"
