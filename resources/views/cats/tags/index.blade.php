...
@section('title', 'Tags | Lam - School Management App')

@section('title-topbar', __('basic.tags'))
...
<div class="container-fluid px-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="text-gray-300"> {{ __('basic.tags') }}</a>
        </span>

        <div class="d-flex justify-content-center">
            <a href="{{ route('sett.tag.create') }}"
    ...
    <div class="card shadow mb-3 pb-2">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-2"></i> {{ __('basic.tag') }}</h6>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('sett.tag.edit', $iteam->id) }}"
