...
@section('title', $patient->first_name)
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 fw-bold">Current Treatment</h6>
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="text-gray-700 text-xs fw-bold">02/04/2020</p>
                                        </div>
                                        <div class="col">
                                            <h6 class="text-gray-300 text-xs mb-1">Type</h6>
                                            <p class="text-gray-700 text-xs fw-bold">Laser treatment</p>
                                        </div>
                                        <div class="col">
                                            <h6 class="text-gray-300 text-xs mb-1">Type</h6>
                                            <p class="text-gray-700 text-xs fw-bold">Laser treatment</p>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="me-1 d-flex align-self-center align-items-center me-2 text-truncate">
                                        ...
                                        <div class="text-truncate">
                                            ...
                                            <p class="text-xs text-gray-300 fw-bold mb-0">{{ $msg }}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="addmedic" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content b-r-s-cont border-0">
                                        ...
                                        <form action="{{ route('sett.medicine.store') }}" method="post">
                                            {{ method_field('POST') }}
                                            {{ csrf_field() }}
                                            ...
                                            <div class="modal-body px-5 py-3">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12 mb-2">
                                                        ...
                                                        <select
                                                            class="myselect2_modal select2-hidden-accessible @error('medicine_pills') is-invalid @enderror"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <div class="right-side">
                                                    <button type="submit"
                                                        class="btn btn-default btn-link main-color">Add New</button>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="modal-content b-r-s-cont border-0">
                                        ...
                                        <div class="modal-body px-4">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table display datatable-modal" id="p-lab-table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <div class="modal fade" id="delete1" tabindex="-1"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    class="modal-content shadow-lgg b-r-s-cont border-0">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('sett.admin.destroy', 'test') }}"
                                                                        method="post">
                                                                        {{ method_field('delete') }}
                                                                        {{ csrf_field() }}
                                                                        ...
                                                                        <div class="modal-body px-4">
                                                                            ...
                                                                            <div
                                                                                class="modal-body delete-conf-input text-center py-0">
                                                                                <p class="mb-0">ِAre
                            ...
                            <div class="modal fade" id="medicine_edit" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content b-r-s-cont border-0">
                                        ...
                                        <form action="{{ route('sett.medicine.update', '21') }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <label class="form-label">Medicine
                                                            <small>(required)</small></label>
                                                        <select
                                                            class="myselect2_modal2 select2-hidden-accessible @error('medicine_pills_update') is-invalid @enderror"
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <label class="form-label">Status
                                                            <small>(required)</small></label>
                                                        <select
                                                            class="myselect2_modal2 select2-hidden-accessible select2-no-search @error('status_medicine_update') is-invalid @enderror"
                        ...
                        <li class="row flex-nowrap list-group-item d-flex justify-content-between position-relative">
                            ...
                            <div class="col text-center align-self-center me-1">
                                ...
                                <h6 class="text-s text-gray-400 text-truncate">
                                    @if (isset($iteam->doctor->first_name))
                                    {{ $iteam->doctor->first_name }}
                                    @else
                                    Not selected
                                    @endif
                                </h6>
...
<script>
    ...
    //lab modals
    $(".lab-pp-edit").on('click', function() {
        //  ret = DetailsView.GetProject($(this).attr("#data-id"), OnComplete, OnTimeOut, OnError);
        iteamID = $(this).attr("data-id");

        $('#labModal').modal('hide');

        $('#testmodalid').html(iteamID);

        $('#labModal2').modal('show');
    });
</script>
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        html +=
                            '<div class="d-flex justify-content-between align-items-center mb-3">' +
                            '<div class="me-1 d-flex align-self-center align-items-center me-2 text-truncate">' +
                            '<i class="fas fa-circle me-2 text-xxs mb-0 main-color"></i>' +
                            '<div class="text-truncate">' +
                            '<p class="text-s text-truncate text-gray-700 mb-0 fw-bold">' +
                            value.medicinescats.name + '</p>' +
                            '<p class="text-xs text-gray-300 fw-bold mb-0">On medicine</p>' +
                            '</div></div>' +
                            '<div class="text-s text-gray-600 fw-bold">' +
                            value.end +
                            '</div></div>'
