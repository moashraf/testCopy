    ...
    <div class="page-break">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold"><i class="fas fa-bus me-1"></i>{{ __('basic.bus') }}</h6>
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                        ...
                        <div class="dropdown-header">Hotel controller:</div>
            ...
            <div class="card-body pb-2 overflow-scroll">
                ...
                <ul class="list-group patient-timeline">
                    ...
                    @foreach ($patient->transp as $item)
                    ...
                    <li class="row flex-nowrap list-group-item d-flex justify-content-between position-relative">
                        ...
                        <div class="col text-center align-self-center me-1">
                            ...
                            @if($item->bus_trip)
                            <h6 class="text-s text-gray-400">{{ $item->bus_trip->name }}</h6>
                            @else
        ...
        <div class="modal fade" id="bus_show" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                <div class="modal-content b-r-s-cont border-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fas fa-bus me-1"></i>
                            {{ __('basic.bus') }}</h5>
                    ...
                    <div class="modal-body px-4">
                        ...
                        <div class="table-responsive">
                            <table class="table display datatable-modal" id="table-bus" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-capitalize">
                                            ...
                                            {{ $bus_type . ' with ' . $item->quantity }} seats
                                        </td>
