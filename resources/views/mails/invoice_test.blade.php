...
<div width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F5F8FA;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0px 22px;" class="email_container">
        ...
        <div class="center_cont border_radius_15">
            ...
            <h6 class="text-gray-500 fw-normal">Welcome to <span> Company name.</span> Your booking
            ...
            <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                @foreach ($booking->invoice_items as $item)
                <tr style="border-bottom: 1px solid rgba(0,0,0,.05); padding-bottom: 20px;">
                    <td valign="middle" width="50%" style="text-align:left; padding: 0 0.5em;">
                        <div class="product-entry">
                            <div class="text">
                                <h6 class="mb-6 fw-normal"> {{ $item->categorizable->name }} @if ($item->days)
                                    for {{ $item->days }} days
                                    @endif</h6>
                                <p class="fs-7 mb-0 text-gray-300 fw-bold">
                                    {{ __('basic.unit price') . ':'}} <span class="text-gray-700">{{ $item->price
                                        }} <small class="text-gray-300 fs-7">{{ $booking->currency->code
                                            }}</small></span>
                                </p>
                            </div>
                        </div>
                    ...
                    <td valign="middle" width="40%" style="text-align:right; padding: 0 2.5em;">
                        <span class="price" style="color: #000; font-size: 20px;">{{ $item->subtotal }}<small
                                class="text-gray-300 fs-7">{{ $booking->currency->code }}</small></span>
                    </td>
                </tr>
            ...
            <table>
                ...
                <tr class="fs-6">
                    ...
                    <th width="100%" style="text-align:right; padding: .5rem 2.5em; color: #000;">
                        <span class="price" style="color: #000; font-size: 20px;">{{ $booking->items_price }}<small
                                class="text-gray-300 fs-7">{{ $booking->currency->code }}</small></span>
                    </th>
                </tr>
                ...
                <tr class="fs-6">
                    ...
                    <th width="100%" style="text-align:right; padding: .5rem 2.5em; color: #000;">
                        <span class="price" style="color: #000; font-size: 20px;">
                            ...
                            @else
                            0
                            @endif<small class="text-gray-300 fs-7">{{ $booking->currency->code }}</small></span>
                    </th>
                </tr>
                ...
                <tr class="fs-6">
                    ...
                    <th width="100%" style="text-align:right; padding: .5rem 2.5em; color: #000;">
                        <span class="price" style="color: #000; font-size: 20px;">{{ $booking->total_tax }}<small
                                class="text-gray-300 fs-7">{{ $booking->currency->code }}</small></span>
                    </th>
                </tr>
                ...
                <tr class="fs-6"
                    ...
                    <th width="100%"
                        ...
                        <span class="price" style="color: #000; font-size: 20px;">{{ $booking->final_price }}<small
                                class="text-gray-300 fs-7">{{ $booking->currency->code }}</small></span>
                    </th>
                </tr>
            </table>
            ...
            <tr>
                <td valign="middle" style="text-align:left; padding: 1.4em 0em 0em .5em;">
                    <p><a href="{{ route('invo_invoice_print', $booking->code) }}" class="btn btn-primary">
        ...
        <tr>
            <td class="bg_white mt-2 mb-2 pt-4 pb-4" style="text-align: center;">
                <p class="text-gray-400 mt-6 mb-3 pb-6">Copyright © 2023 Tripo TUR v1.6 | Company Name
                </p>
            </td>
        </tr>
    </div>
