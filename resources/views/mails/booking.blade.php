...
<div width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F5F8FA;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0px 22px;" class="email_container">
        ...
        <div class="center_cont border_radius_15">
            ...
            <h6 class="text-gray-500 fw-normal">Welcome to <span> {{ $details['company_name'] }}.</span> Your booking
                has been confirmed successfully.</h6>
            <h6 class="fw-normal">Here is your confirmation code:</h6>
            <div class="text-center main-color-bg text-white p-4 border_radius_10">
                <h6 class="mb-0">{{ $details['booking']->code }}</h6>
            </div>
            ...
            <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                @if(count($details['booking']->hotel) > 0)
                ...
                @foreach ($details['booking']->hotel as $item)
                ...
                <tr style="border-bottom: 1px solid rgba(0,0,0,.05); padding-bottom: 20px;">
                    ...
                    <td valign="middle" width="100%" style="text-align:right; padding: 0 2.5em;">
                        <p class="mb-0 text-gray-400 fs-7">{{ __('basic.price for') . ' ' .$item->nights . ' ' .
                            __('basic.nights') }}</p>
                        @if($item->invoice_item && $details['booking']->invoice)
                        <span class="price" style="color: #000; font-size: 20px;">{{ $selling_price }}<small
                                class="text-gray-300 fs-7">{{ $details['booking']->invoice->currency->code
                                }}</small></span>
                        @endif
                    </td>
                </tr>
                ...
                @if(count($details['booking']->transportation) > 0)
                ...
                @foreach ($details['booking']->transportation as $item)
                ...
                {{-- visa booking --}}
                @if(count($details['booking']->visa) > 0)
                ...
                @foreach ($details['booking']->visa as $item)
                ...
                {{-- trip booking --}}
                @if(count($details['booking']->trip) > 0)
                ...
                @foreach ($details['booking']->trip as $item)
                ...
                {{-- airline booking --}}
                @if(count($details['booking']->airline) > 0)
                ...
                @foreach ($details['booking']->airline as $item)
                ...
                {{-- package booking --}}
                @if(count($details['booking']->package) > 0)
                ...
                @foreach ($details['booking']->package as $item)
                ...
                <tr style="border-bottom: 1px solid rgba(0,0,0,.05); padding-bottom: 20px;">
                    <td valign="middle" width="80%" style="text-align:left; padding: 0 0.5em;">
                        <div class="product-entry">
                            ...
                            <img style="width: 10% !important" alt=""
                                src="{{ URL::asset('img/package/' . $item->package->main_image) }}">
                ...
                <tr class="fs-6"
                    ...
                    <th width="100%"
                        ...
                        @if($details['booking']->invoice)
                        <span class="price" style="color: #000; font-size: 20px;">{{ $total_sell }}<small
                                class="text-gray-300 fs-7">{{ $details['booking']->invoice->currency->code
                                }}</small></span>
                        @endif
                    </th>
                ...
                <tr>
                    <td valign="middle" style="text-align:left; padding: 1.4em 0em 0em .5em;">
                        <p><a href="{{ route('booking_print', $details['booking']->code) }}" class="btn btn-primary">
