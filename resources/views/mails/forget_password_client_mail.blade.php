...
<div width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F5F8FA;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0px 22px;" class="email_container">
        ...
        <div class="center_cont border_radius_15">
            ...
            <h6 class="text-gray-500 fw-normal">You are receiving this email because we received a password reset
                request for your account on <span> {{ $details['company_name'] }}.</span></h6>
            <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td valign="middle" style="text-align:left; padding: 1.4em 0em 0em .5em;">
                        <p><a href="{{ route('school_route.reset_password', $details['token']) }}"
                                class="btn btn-primary">
                                Rest Password</a></p>
                    </td>
                </tr>
            </table>
            <h6 class="text-gray-500 fw-normal">This password reset link will expire in 60 minutes</h6>
            <h6 class="text-gray-500 fw-normal">If you did not request a pssword reset, no further action is required.
            </h6>

            <hr>
            <h6 class="text-gray-500 fw-normal">If you're having trouble clicking the "Rest Password" buttom, copy and
                paste the URL Belo into your web browser: {{ route('school_route.reset_password', $details['token']) }}
            </h6>
        </div>
