...
@section('title', 'Edit buses | Lam - School Management App')

@section('title-topbar', 'Edit buses')
...
<div class="container-fluid px-0 px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.buses.index') }}">{{ __('basic.buses')
                }} |
            </a>
            <a class="text-gray-300">{{ __('edit buses') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-headset me-1"></i>
                {{ __('edit buses') }}</h6>
        </div>
        ...
        <div class="card-body px-4 px-md-5">
            ...
            <form id="myform" method="POST" action="{{ route('sett.buses.update', $item->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Bus Name.." value="{{ $item->name }}" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="seats" type="number"
                                    ...
                                    placeholder="Seats number.." value="{{ $item->seats }}" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select id="bus_chart"
                                    ...
                                    <option @if ($item->bus_chart === "bus_49")
                                        selected
                                        @endif value="bus_49">bus_49</option>
                                    <option @if ($item->bus_chart === "bus_14")
                                        selected
                                        @endif value="bus_14">bus_14</option>
                                    <option @if ($item->bus_chart === "limo_4")
                                        selected
                                        @endif value="limo_4">limo_4</option>
                                </select>
