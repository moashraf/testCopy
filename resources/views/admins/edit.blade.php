...
@section('title-topbar', __('basic.edit'))
...
<div class="container-fluid px-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.home') }}">{{ __('basic.dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.admin.index') }}">{{ __('basic.users')
                }} | </a>
            <a class="text-gray-300">{{ __('basic.edit') }}</a>
        </span>
    </div>
    ...
    <div class="card card-input shadow mb-3 pb-3">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-user-edit me-2"></i> {{ __('basic.edit') }} {{
                $user->first_name }}
                {{ __('basic.profile') }}
            </h6>
        </div>
        ...
        <div class="card-body px-3">
            ...
            <div class="multi-setps-form-calander col-12">
                ...
                <form id="myform" class="myform" method="POST" action="{{ route('sett.admin.update', $user->id) }}"
                    ...
                    <div class="cont_tap " id="clinics">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <label class="form-label">{{ __('patientappo.role') }} <small>({{ __('basic.required')
                                        }})</small></label>
                                <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                    ...
                                    <option value="{{ $iteam->id }}" @if (in_array($iteam->id, $userRole)) selected
                                        @endif>
                                        {{ $iteam->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-2">
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                @else
                                <div class="form-text text-gray-200">Leave it empty if you do not want to change
                                    it.
                                </div>
                                @endif
                            </div>
                    ...
                    <div class="cont_tap" id="time">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <select
                                    ...
                                    name="religion">
                                    <option value="1" @if ($user->religion == 1) selected @endif>{{ __('basic.not
                                        selected') }}</option>
                                    <option value="2" @if ($user->religion == 2) selected @endif>{{ __('basic.muslim')
                                        }}</option>
                                    <option value="3" @if ($user->religion == 3) selected @endif>{{
                                        __('basic.christian') }}</option>
                                </select>
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <input name="identity_doc_number" type="text"
                                    ...
                                    value="{{ $user->identity_doc_number }}">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-md-4 mb-2">
                                <label class="form-label">{{ __('basic.country') }} <small>({{ __('basic.required')
                                        }})</small></label>
                                <select
                            ...
                            <div class="col-12 col-md-4 mb-2">
                                <label class="form-label">{{ __('basic.city') }} <small>({{ __('basic.required')
                                        }})</small></label>
                                <select
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <select
                                    ...
                                    <option value="{{ $item->id }}" @if($user->user_edu_qualification_id == $item->id)
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <select
                                    ...
                                    name="marital_status">
                                    <option value="1" @if($user->marital_status == 1) selected @endif>{{
                                        __('basic.not selected') }}</option>
                                    <option value="2" @if($user->marital_status == 2) selected @endif>{{
                                        __('basic.single martial status') }}</option>
                                    <option value="3" @if($user->marital_status == 3) selected @endif>{{
                                        __('basic.married') }}</option>
                                    <option value="4" @if($user->marital_status == 4) selected @endif>{{
                                        __('basic.divorced') }}</option>
                                    <option value="5" @if($user->marital_status == 5) selected @endif>{{
                                        __('basic.widowed') }}</option>
                                </select>
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <select
                                    ...
                                    <option value="1" @if($user->military_status == 1) selected @endif>{{
                                        __('basic.not selected') }}</option>
                                    <option value="2" @if($user->military_status == 2) selected @endif>{{
                                        __('basic.does not have') }}</option>
                                    <option value="3" @if($user->military_status == 3) selected @endif>{{
                                        __('basic.done') }}</option>
                                    <option value="4" @if($user->military_status == 4) selected @endif>{{
                                        __('basic.exempted') }}</option>
                                    <option value="5" @if($user->military_status == 5) selected @endif>{{
                                        __('basic.postponed') }}</option>
                                </select>
                            ...
                            <div class="col-12 col-md-3 mb-2">
                                ...
                                <select
                                    ...
                                    <option value="1" @if($user->driving_license == 1) selected @endif>
                                        {{ __('basic.not selected') }}</option>
                                    <option value="2" @if($user->driving_license == 2) selected @endif>{{
                                        __('basic.private license') }}</option>
                                </select>
                    ...
                    <div class="cont_tap" id="about">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-4 mb-2">
                                ...
                                <select
                                    ...
                                    <option value="{{ $item->id }}" @if($user->job_title_id == $item->id) selected
                                        @endif>{{ $item->name
                                        }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-md-4 mb-2">
                                ...
                                <select
                                    ...
                                    <option value="0" @if ($user->deactivate === '0') selected @endif>{{
                                        __('basic.active') }}
                                    </option>
                                    <option value="1" @if ($user->deactivate === '1') selected @endif>
                                        {{ __('basic.deactivate') }}</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <label class="form-label">{{ __('basic.all images') }}</label>
                            @foreach ($user->imgs as $item)
                            <div class="col-12 col-md-3 mb-2 position-relative w-60 h-60">
                                <img src="{{ URL::asset('img/useravatar/attachments/' . $item->img) }}"
                                    class="picture-src w-50 img_object_contain" id="mib_PicturePreview" title=""
                                    style="height: 113px !important;" />
                                <a target="_blank" class="btn btn-primary position-absolute z-index-1"
                                    style="left:0px; opacity:70%;"
                                    href="{{ URL::asset('img/useravatar/attachments/' . $item->img) }}"><i
                                        class="fas fa-download"></i></a>
                                <a class="btn btn-danger position-absolute z-index-1" style="right:107px; opacity:70%;"
                                    href="{{ route('sett.user_deleteImage', $item->id) }}"><i
                        ...
                        <div class="row mb-2">
                            <div class="mb-3">
                                <label class="form-label">{{ __('basic.note') }} <small>({{ __('basic.optional')
                                        }})</small></label>
